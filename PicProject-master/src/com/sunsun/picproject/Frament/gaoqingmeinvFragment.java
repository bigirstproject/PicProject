...
public class gaoqingmeinvFragment extends BaseListFragment<GalleryTable> {
	private static final String TAG  =gaoqingmeinvFragment.class.getName();
	...
	protected void handleBackgroundMessage(Message msg) {
			...
			try {
				...
				if (pageline != null) {
					...
					if (a != null) {
						...
						morePageCode = morePageCode.substring(firstIndex + 1,
								lastIndex);
					}
				}
				/* pageCode */
		...
		case REQUEST_MORE_CODE:
			if (msg != null) {
				...
				try {
					String url = Constants.MENUMOTE_MORE + morePageCode
							+ Constants.PAGE + pagesize;
					...
					for (int i = 0; i < json.length(); i++) {
						...
						GalleryTable table = new GalleryTable();
						table.setId(i);
						table.setImage("http://img.1985t.com/"+object.getString("picture"));
						table.setUrl("http://m.4493.com/xingganmote/"+object.getString("id")+".html");
						table.setType(RecommendAdapter.TYPE);
