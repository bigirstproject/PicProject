...
public class GoodsRecommendFragment extends BaseListFragment<GalleryTable> {
	private static final String TAG  =GoodsRecommendFragment.class.getName();

	
	public static final String URL = "url";
	public static final String RECOMMEDD_ID = "recommend_id";
