...
public class MotemeinvFragment extends BaseListFragment<GalleryTable> {
	private static final String TAG = MotemeinvFragment.class.getName();
			...
			if (msg != null) {
				...
				try {
					...
					for (int i = 0; i < json.length(); i++) {
						...
						GalleryTable table = new GalleryTable();
						table.setId(i);
						table.setImage("http://img.1985t.com/"
								+ object.getString("picture"));
						table.setUrl("http://m.4493.com/xingganmote/"
								+ object.getString("id") + ".html");
						table.setType(RecommendAdapter.TYPE);
