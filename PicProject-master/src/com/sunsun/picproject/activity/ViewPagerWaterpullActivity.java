...
import com.sunsun.picproject.Frament.ViewPagerWaterPullFragment;
...
public class ViewPagerWaterpullActivity extends BaseWorkerFragmentActivity {

	public static final String TAG = ViewPagerWaterpullActivity.class
			.getSimpleName();

	public static void startViewPagerWaterpullActivity(Context context,
			String url) {
		Intent intent = new Intent(context, ViewPagerWaterpullActivity.class);
	 ...
	 */
	public void showAds() {
		WSA mjokeM = WSA.getInstance(ViewPagerWaterpullActivity.this,
	...
	public void onResume() {
		...
		FragmentTransaction transaction = getSupportFragmentManager()
				.beginTransaction();
		if (mFragment == null) {
			mFragment = new ViewPagerWaterPullFragment();
	...
	private void loadSpotAds() {
		...
		SpotManager.getInstance(ViewPagerWaterpullActivity.this).showSpotAds(
				ViewPagerWaterpullActivity.this, null);
	}
